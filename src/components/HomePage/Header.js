            ...
            <div className="container mx-auto">
                ...
                <div className="container mx-auto">
                    <div className="absolute grid p-2 lg:grid-cols-4 mr-20 mt-20 xl:mt-[100px]  text-white">
                        ...
                        <div>
                            <p>Explore your dream home with ease on our real estate website, where cutting-edge search features and detailed property listings bring you closer to finding the perfect match.</p>
